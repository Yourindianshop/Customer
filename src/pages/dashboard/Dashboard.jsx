...
const Dashboard = () => {
    ...
    <div id="dash-cont">
      ...
      <div className="ds-top" >
              <Link to="/dashboard/profile" className="ds-left">
                <small style={{color: "black", fontWeight: "700", fontFamily: "var(--font3)"}}>Welcome</small>
                <br />
                <h1 style={{color: "black", fontWeight: "700", fontFamily: "var(--font3)"}}>{user?.Name}</h1>
              </Link>
  ...
  <div class="flip-card-inner">
    ...
    <div className="ds-c" style={{ display: "flex", flexDirection: "column", justifyContent: "center"}}>
  ...
  <div class="flip-card-inner">
    ...
    <div className="ds-c" style={{ display: "flex", flexDirection: "column", justifyContent: "center"}}>
            ...
            {pktinfo && <big style={{marginTop: "1rem"}}>₹{user?.Wallete}</big>}
    </div>
    </div>
    <div class="flip-card-back">
      <h1>John Doe</h1>
  ...
  <div class="flip-card-inner">
    ...
    <div className="ds-c" style={{ display: "flex", flexDirection: "column", justifyContent: "center"}}>
            ...
            {pktinfo && <big style={{marginTop: "1rem"}}>{pktinfo.Locker} packages</big>}
    </div>
    </div>
    <div class="flip-card-back">
      <h1>John Doe</h1>
  ...
  <div class="flip-card-inner">
    ...
    <div className="ds-c" style={{ display: "flex", flexDirection: "column", justifyContent: "center"}}>
            ...
            {pktinfo && <big style={{marginTop: "1rem"}}>{pktinfo.Dispatched} packages</big>}
    </div>
    </div>
    <div class="flip-card-back">
      <h1>John Doe</h1>
  ...
  <div class="flip-card-inner">
    ...
    <div className="ds-c" style={{ display: "flex", flexDirection: "column", justifyContent: "center"}}>
            ...
            {pktinfo && <big style={{marginTop: "1rem"}}>{pktinfo.Delivered} packages</big>}
    </div>
    </div>
    <div class="flip-card-back">
      <h1>John Doe</h1>
