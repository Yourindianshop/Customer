          ...
          <div id="wl-sec-1" className="ngp">
            <div className="ws-l ml2">
              ...
              <p>
                ...
                multiple products already added by the admin. If a specific
                product required by the customer is not present in the assisted
                purchase section, the customer will have the provision to
                request the admin to add that product to the assisted purchase
                section.
              </p>
              <Link to="/disp-plan" className="btn btn-b">
                Explore
              </Link>
            </div>
          ...
          <div id="pl-kd-sec" className="nmar">
            <div className="kd-l">
              ...
              <p>
                ...
                corrupti. Architecto quam, aliquam neque obcaecati ipsum sit
                aperiam ex tenetur perferendis.
              </p>
              <Link to="/disp-plan">
                {" "}
            ...
            <div className="kd-r">
              <div className="kd-pl">
                ...
                <div className="futrsss">
                  ...
                  <span>
                    {" "}
                    <CheckCircleOutlineOutlinedIcon id="ck-cr" /> storage - 30
                    days
                  </span>
                  <span>
                    {" "}
                  ...
                  <span>
                    {" "}
                    <CheckCircleOutlineOutlinedIcon id="ck-cr" /> unlimited
                    address
                  </span>
              ...
              <div className="kd-pl">
                ...
                <div className="futrsss">
                  ...
                  <span>
                    {" "}
                    <CheckCircleOutlineOutlinedIcon id="ck-cr" /> virtual
                    address
                  </span>
                  <span>
                    {" "}
                  ...
                  <span>
                    {" "}
                    <CheckCircleOutlineOutlinedIcon id="ck-cr" /> real time
                    tracking
                  </span>
                  <span>
                    {" "}
